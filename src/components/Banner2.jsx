    ...
    return(
        <div className="bg-white flex flex-col justify-center items-center py-20">
            <div className="w-[50%] flex flex-col justify-center items-center text-center ">
                <p className=" font-bold text-5xl">Join the Community</p>
                <p className=" leading-relaxed text-gray-600 my-5 text-lg">
                roadmap.sh is the <a className="font-medium text-gray-600 underline underline-offset-2 hover:text-black">7th most starred project on GitHub</a> and is visited by hundreds of thousands of developers every month.
                </p>
            </div>
            <div className="mt-5 grid  justify-between my-11 grid-cols-3 gap-0 divide-x mb-4 mb-0">
                 <div className="flex items-center  flex-col justify-center gap-0 bg-transparent rounded-none p-4 mb-0"> 
                    <p className="flex items-center text-sm text-blue-500 ">
                         <span className="rounded-md bg-blue-500 px-1 text-white">Rank 7th</span>
                        &nbsp;out of 28M!
                    </p>   
                    <div className="flex items-center flex-col my-0"> 
                        <p className="my-4 mr-0  font-bold w-auto text-5xl"> 295K </p>
                        <p className="text-xs tracking-wide text-black -mt-3 mb-5"> GitHub Stars </p> 
                    </div> 
                    <a href="https://github.com/kamranahmedse/developer-roadmap" target="_blank" class="group mt-0 flex flex-col items-center rounded-lg border border-black bg-white px-3 py-2 text-sm hover:bg-black hover:text-white">
                        <div class="mb-0.5 flex items-center font-semibold"> 
                            <svg class="-ml-1 fill-current" focusable="false" width="14" height="15" viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-xs text-gray-500 group-hover:text-gray-100">Help us reach #1</span> 
                    </a>   
                </div> 
                <div className="flex items-center  flex-col justify-center gap-0 bg-transparent rounded-none p-4 mb-0"> 
                    <p className="flex items-center text-sm text-blue-500 ">
                         <span class="rounded-md bg-blue-500 px-1 text-white">+90k</span>
                        &nbsp;every month
                    </p>   
                    <div className="flex items-center flex-col my-0"> 
                    ...
                    <a  className="group mt-0 flex flex-col items-center rounded-lg border border-black bg-white px-3 py-2 text-sm hover:bg-black hover:text-white">
                        ...
                        <svg data-v-f24af897="" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" strokelinejoin="round" class="-ml-1 h-[15px] fill-current"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M22 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> 
                            <span class="ml-1.5 hover:block">Register yourself</span> 
                        </div> 
                        <span class="text-xs text-gray-500 group-hover:text-gray-100">Commit to your growth</span> 
                    </a>   
                </div> 
                <div class="flex items-center  flex-col justify-center gap-0 bg-transparent rounded-none p-4 mb-0"> 
                    <p class="flex items-center text-sm text-blue-500 ">
                         <span class="rounded-md bg-blue-500 px-1 text-white">+1.5K</span>
                        &nbsp;every month
                    </p>   
                    <div class="flex  items-center flex-col my-0"> 
                        <p class="my-4 mr-0 font-bold w-auto text-5xl"> 28K </p>
                        <p class=" text-xs tracking-wide text-black -mt-3 mb-5"> Discord Members </p> 
                    </div> 
                    <a  className="group mt-0 flex flex-col items-center rounded-lg border border-black bg-white px-3 py-2 text-sm hover:bg-black hover:text-white">
                        <div className="mb-0.5 flex items-center font-semibold"> 
                        <svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="-ml-1 h-[13px] fill-current">
                            ...
                            <span className="ml-1.5 hover:block">Join on Discord</span> 
                        </div> 
                        <span className="text-xs text-gray-500 group-hover:text-gray-100">Join the community</span> 
                    </a>   
                </div>  
            </div>
        </div>
